...
class EstablecimientosTipos_model extends CI_Model
{
    ...
    public function get($filtros=null)
    {
        if(!is_null($filtros)){
            $this->db->distinct();
            $this->db->select('establecimientos_tipos_grupos.id as establecimiento_tipo_id,establecimientos_tipos_grupos.denominacion_es as establecimiento_tipo_denominacion_es,establecimientos_tipos_grupos.denominacion_en as establecimiento_tipo_denominacion_en,establecimientos_tipos_grupos.denominacion_plural_es as establecimiento_tipo_denominacion_plural_es,establecimientos_tipos_grupos.denominacion_plural_en as establecimiento_tipo_denominacion_plural_en');
